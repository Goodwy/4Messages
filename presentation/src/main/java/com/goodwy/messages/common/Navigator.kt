...
class Navigator @Inject constructor(
    ...
    fun showQksmsPlusActivity(source: String) {
        analyticsManager.track("Viewed 4Messages+", Pair("source", source))
    ...
    fun showDeveloper() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/dev?id=8268163890866913014"))
        startActivityExternal(intent)
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/goodwy/4messages"))
        startActivityExternal(intent)
    }

    fun showChangelog() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/goodwy/4messages/releases"))
        startActivityExternal(intent)
    }

    fun showLicense() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/goodwy/4messages/blob/master/LICENSE"))
        startActivityExternal(intent)
    }
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("goodwy.dev@gmail.com"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "4Messages Support")
    ...
    fun showInvite() {
        ...
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.goodwy.messages")
