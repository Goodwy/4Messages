 ...
 */
package com.goodwy.messages.feature.plus.experiment
...
class UpgradeButtonExperiment @Inject constructor(
    ...
    override val variants: List<Variant<Int>> = listOf(
            Variant("variant_a", R.string.messages_plus_upgrade),
            Variant("variant_b", R.string.messages_plus_upgrade_b),
            Variant("variant_c", R.string.messages_plus_upgrade_c),
            Variant("variant_d", R.string.messages_plus_upgrade_d))

    override val default: Int = R.string.messages_plus_upgrade
