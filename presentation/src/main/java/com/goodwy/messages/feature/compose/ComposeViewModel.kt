...
import com.goodwy.messages.interactor.AddScheduledMessage
import com.goodwy.messages.interactor.CancelDelayedMessage
import com.goodwy.messages.interactor.DeleteMessages
import com.goodwy.messages.interactor.MarkRead
import com.goodwy.messages.interactor.RetrySending
import com.goodwy.messages.interactor.SendMessage
...
import com.goodwy.messages.model.Attachments
...
import com.goodwy.messages.util.ActiveSubscriptionObservable
...
class ComposeViewModel @Inject constructor(
    ...
    override fun bindView(view: ComposeView) {
        ...
        view.cameraIntent
                .autoDisposable(view.scope())
                .subscribe {
                    if (permissionManager.hasStorage() || view.isRPlus()) {
