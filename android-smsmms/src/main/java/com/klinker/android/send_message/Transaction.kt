...
class Transaction @JvmOverloads constructor(private val context: Context, settings: Settings = Settings()) {
    ...
    companion object {
        ...
        const val MMS_SENT = "com.goodwy.messages.MMS_SENT"
        const val EXTRA_CONTENT_URI = "content_uri"
        const val EXTRA_FILE_PATH = "file_path"

        const val NOTIFY_SMS_FAILURE = "com.goodwy.messages.NOTIFY_SMS_FAILURE"
        const val MMS_UPDATED = "com.goodwy.messages.MMS_UPDATED"
